...
export default function Home() {
  ...
  return (
    <section className="mx-auto flex w-full max-w-5xl flex-1 items-center py-1 sm:py-2 md:py-4">
      <div className="grid w-full gap-6 rounded-[2rem] border border-white/10 bg-slate-900/70 px-4 py-6 shadow-[0_30px_80px_rgba(2,6,23,0.45)] backdrop-blur sm:px-8 sm:py-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-8 lg:px-10">
        <div className="text-center lg:text-left">
          ...
          <h1 className="mt-4 text-[2rem] font-black tracking-tight text-white sm:text-4xl lg:max-w-2xl lg:text-5xl">
            Fast emergency access with a single focused action.
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-slate-400 sm:text-base lg:mx-0 lg:max-w-lg">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {!isSignedIn ? (
            <div className="mt-4 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium text-slate-300">
        ...
        {!isSignedIn ? (
          <div className="lg:col-span-2">
            <div className="mt-1 flex flex-col items-center justify-center gap-3 border-t border-white/10 pt-5 text-center sm:flex-row sm:justify-between sm:text-left">
